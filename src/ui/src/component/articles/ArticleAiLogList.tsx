...
function ArticleAiLogList({articleId}: ArticleAiLogListProps) {
	...
	const loadPageHandler = useCallback(
		() => {
			restClient
				.aiLog
				.loadByEntity('Article', articleId, paging)
				.then(setLogs)
				.catch((e: Error) => {
					setLogs(null);
					userAlerts.err(e);
		...
		[paging, articleId, restClient, userAlerts]
	);
...
export default ArticleAiLogList;
